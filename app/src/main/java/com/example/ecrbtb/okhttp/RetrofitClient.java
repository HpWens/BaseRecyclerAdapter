...
import com.example.ecrbtb.okhttp.entity.IpResult;
...
public class RetrofitClient {
    ...
    private RetrofitClient(Context context, String url) {
        ...
        okHttpClient = new OkHttpClient.Builder().addNetworkInterceptor(
                ...
                .connectionPool(new ConnectionPool(6, 10, TimeUnit.SECONDS))
                .build();
    ...
    private RetrofitClient(Context context, String url, Map<String, String> headers) {
        ...
        okHttpClient = new OkHttpClient.Builder()
                .addNetworkInterceptor(
                        new HttpLoggingInterceptor().setLevel(HttpLoggingInterceptor.Level.BODY))
                //.cookieJar(new NovateCookieManger(context))//使用父类/接口替换子类，即ConcurrentMap替换ConcurrentHashMap声明 报错
                .cache(cache)
...
//    public Subscription get(String url, Map parameters, Subscriber<ResponseBody> subscriber) {
//
...
//    }
     ...
     * @param subscriber
     */
    public void postInIo(String url, Map<String, String> parameters, Subscriber<ResponseBody>
            subscriber) {
        apiService.executePost(url, parameters)
