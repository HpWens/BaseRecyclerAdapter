...
public class IOSTaoBaoDialog extends BottomBaseDialog<IOSTaoBaoDialog> {
    ...
    public View onCreateView() {
        ...
        mLlSms= (LinearLayout) inflate.findViewById(R.id.ll_sms);

        mLlQq= (LinearLayout) inflate.findViewById(R.id.ll_qq);

        mLlWechatFriend= (LinearLayout) inflate.findViewById(R.id.ll_wechat_friend);

        mLlWechatFriendCircle= (LinearLayout) inflate.findViewById(R.id.ll_wechat_friend_circle);
