...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private int mTransType = -1;//默认不支持转换
    private int mTransLayoutResId;
    ...
    public static final int TRANS_LINEAR_VIEW = 0x00000666;
    public static final int TRANS_GRID_VIEW = 0x00000777;

    public static final int TRANS_LINEAR_TYPE = 0;
    public static final int TRANS_GRID_TYPE = 1;
     ...
     * Use with {@link #openLoadAnimation}
     */
    public static final int CUSTOM = 0x00000008;
    ...
    public BaseQuickAdapter(int layoutResId, int transLayoutResId, List<T> data) {
        this(layoutResId, data);
        if (transLayoutResId != 0) {
            this.mTransLayoutResId = transLayoutResId;
        }
    }
    ...
    public int getItemViewType(int position) {
        ...
        if (position < numHeaders) {
            ...
            if (adjPosition < adapterCount) {
                if (mTransType == TRANS_LINEAR_TYPE) {
                    return TRANS_LINEAR_VIEW;
                } else if (mTransType == TRANS_GRID_TYPE) {
                    return TRANS_GRID_VIEW;
                }
    ...
    public K onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case FOOTER_VIEW:
                ...
                break;
            case TRANS_LINEAR_VIEW:
                baseViewHolder = createBaseViewHolder(parent, mLayoutResId);
                break;
            case TRANS_GRID_VIEW:
                baseViewHolder = createBaseViewHolder(parent, mTransLayoutResId);
                break;
            default:
